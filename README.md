...
- [LevelUpTutorials Advanced Gatsby & Shopify](https://www.leveluptutorials.com/tutorials/advanced-gatsby-and-shopify/shopify-setup)
...
1. Clone this repo
1. Run `yarn install`
1. Add your Shopify credentials in `gatsby-config.js`
